@if(count($products) != 0)
    @foreach($products as $product)
        <div class="row" style="padding: 5px;border-top: 1px solid rgba(0,0,0,.1)" id="{{$product->product_id}}">
            <div class="col-md-1 " style="padding: 20px ">
                <div class="custom-control custom-checkbox ">
                    <input type="checkbox"  class="custom-control-input check"  id="{{$product->product_id}}" name="">
